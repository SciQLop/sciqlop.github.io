...
<!-- On each release: run scripts/bump-release.sh vX.Y.Z (rewrites the version in the 7 links below and checks them). -->
...
<div class="download-grid">
  <div class="os-card">
    ...
    <h3>Windows</h3>
    <a class="dl-link" href="https://github.com/SciQLop/SciQLop/releases/download/v0.12.2/SciQLop-x64-setup-v0.12.2.exe"><strong>Installer</strong> <small>.exe · x64</small></a>
    <a class="dl-link" href="https://github.com/SciQLop/SciQLop/releases/download/v0.12.2/SciQLop-x64-online-setup-v0.12.2.exe"><strong>Online installer</strong> <small>.exe · x64, small download</small></a>
    <a class="dl-link" href="https://github.com/SciQLop/SciQLop/releases/download/v0.12.2/SciQLop-x64-v0.12.2.msix"><strong>MSIX package</strong> <small>.msix · x64</small></a>
  </div>
  <div class="os-card">
    ...
    <h3>macOS</h3>
    <a class="dl-link" href="https://github.com/SciQLop/SciQLop/releases/download/v0.12.2/SciQLop-arm64-v0.12.2.dmg"><strong>Apple Silicon</strong> <small>.dmg · M1 and later</small></a>
    <a class="dl-link" href="https://github.com/SciQLop/SciQLop/releases/download/v0.12.2/SciQLop-x86_64-v0.12.2.dmg"><strong>Intel</strong> <small>.dmg · x86_64</small></a>
  </div>
  <div class="os-card">
    ...
    <h3>Linux</h3>
    <a class="dl-link" href="https://github.com/SciQLop/SciQLop/releases/download/v0.12.2/SciQLop-x86_64-v0.12.2.AppImage"><strong>AppImage</strong> <small>x86_64, no install needed</small></a>
    <a class="dl-link" href="https://pypi.org/project/SciQLop/"><strong>pip install sciqlop</strong> <small>any platform, from PyPI</small></a>
  </div>
</div>
<p class="download-alt">Latest release: <strong>v0.12.2</strong> ·
