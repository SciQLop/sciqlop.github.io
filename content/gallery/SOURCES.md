...
| `11-ai-assistant-dock.png` | Agents dock (OpenCode backend) mid-job, docked left of the Burch et al. 2016 EDR panel. The visible exchange is the agent verifying Panel2 against the first panel before writing its report. | 2015-10-16 13:05:25–13:07:35 | FGM burst B GSM, FPI-DIS burst N_i, V_i GSE, omni ion energy spectrogram | AI assistant dock, `sciqlop_screenshot_panel` tool output inline in the chat |
